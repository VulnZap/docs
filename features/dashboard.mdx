...
Access the dashboard at: [vulnzap.com/dashboard](https://vulnzap.com/dashboard/dashboard)
...
**Pre-requisite** Authenticate with GitHub and grant repository access -> [settings](https://vulnzap.com/dashboard/settings)
